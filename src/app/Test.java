 ...
 *
 *  NOTE: Time series need to be augmented for including the bias term. For this, method apply() calls the method
 *  augment().
 *
...
public class Test {
    ...
    String data = "Coffee";
    int typeClf = 1;
    String opts = " -e 1 -l 0.1 -R 0 -r 0.01 -b1 0.9 -b2 0.99 -T 5000 -S 250 -o 2 ";
    int flagZNORM = 0;
    double bias = -0.1;
    int seed = 10;
