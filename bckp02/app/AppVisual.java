...
public class AppVisual {
    ...
    String optSM = "-e 20 -A 4 -l 0.1 -r 0.0 -m 0.5 -r1 0.9 -r2 0.9999 -W -10000 -w 2 -s 1 -T 500 -S 1000 -o 3";

    //--- data: 0 = rings; 1 = swiss-roll; 2 = parallel; 3 = xor; 4 = grid; 5 = circle-ring;
    int data = 0;
    ...
    //--- parameter for circle-ring
    int LT = 1;                     // label of circle

    //--- parameter for rings & circle-ring
    double sigma = 1.0;
    double gap = 0.0;
    ...
    public void apply() {
        ...
        if(0 < LOG) {
            ...
            Log logger = new Log(model, logpath, dataname[data], opts.getInt("-e"));
            logger.log(train, 0);
        }
