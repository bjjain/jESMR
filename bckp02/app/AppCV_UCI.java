 ...
 */
public class AppCV_UCI {

    //### OPTIONS ##############################################################

    //--- dataset in UCR format
    private String uci = "ionosphere";
    ...
    String optSM = "-e 2 -A 4 -r 0.0 -m 0.9 -r1 0.9 -r2 0.999 -T 1000 -S 100 -o 0";
    ...
    public void apply(String[] args) {
        ...
        if(X == null) {
            Msg.error("Error. Data set is missing.");
        }
    ...
    private void info(double[] acc) {
        ...
        System.out.println();
        System.out.format("111 %s %s %n", uci, optSM);
        System.out.format("222 %s %s   ", uci, e);
